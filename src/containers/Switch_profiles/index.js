                ...
                {buyItems.length > 0 && (
                  <table className="table">
                    <thead>
                      ...
                      <th scope="col" width="40%" class="text-left">    </th>
                        <th scope="col">Name</th>
                        <th scope="col" width="40%" class="text-right">Total no. of ITLs</th>
                      </tr>
                    </thead>
                    <tbody>
                      {this.state.buyItems.map((item) => {
                        ...
                        <td scope="col" width="20%" class="text-center">{item.id1}</td>
                        <td scope="col" width="20%" class="text-right">{item.value}</td>
                          </tr>
                        );
                      })}
                    </tbody>
